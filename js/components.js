/* ========================================
   SAPATENGINEERING — components.js
   Shared header, footer, popup, floats
   ======================================== */
...
const SITE = {
  ...
  email: "sapat.hvac.ae@gmail.com",
  emailLink: "mailto:sapat.hvac.ae@gmail.com",
...
function renderHeader() {
  ...
  el.innerHTML = `
    <nav class="nav-wrap">
      <a href="${B}/index.html" class="nav-logo" aria-label="${SITE.name} Home">
        <img src="${B}/icon.webp" class="logo" alt="${SITE.name} logo" width="50" height="50" loading="lazy" onerror="this.style.display='none'">
        <div class="logo-name-tag">
          <span class="logo-name">${SITE.name}</span>
          <span class="logo-tag">${SITE.tagline}</span>
        </div>
      </a>
      ...
      <ul class="nav-links" role="navigation" aria-label="Main navigation">
        ...
        <li class="nav-drop">
          ...
          <ul class="drop-menu">
            ...
            <li><a href="${B}/pages/services/ac-cleaning.html">AC Cleaning</a></li>
    ...
    <nav class="mob-nav" id="mob-nav" aria-label="Mobile navigation">
      ...
      <a href="${B}/pages/services/ac-cleaning.html" class="mob-sub">AC Cleaning Dubai</a>
      ...
      <button class="btn btn-green" data-popup style="margin-top:1rem;width:100%;justify-content:center;">Get a Free Quote</button>
    </nav>
  `;
}
...
function renderFooter() {
  ...
  el.innerHTML = `
    <div class="footer-img-strip">
      <img src="${B}/images/footer-cityscape.jpg" alt="Dubai skyline" width="1440" height="200" loading="lazy" onerror="this.style.display='none'">
      ...
      <div class="container">
        <div class="footer-grid">
          ...
          <div class="foot-brand">
            ...
            <div class="logo-tag">${SITE.tagline} UAE</div>
          ...
          <div class="foot-col">
            ...
            <ul>
              ...
              <li><a href="${B}/pages/services/hvac.html">HVAC Engineering</a></li>
              <li><a href="${B}/pages/services/air-conditioning.html">Air Conditioning</a></li>
              <li><a href="${B}/pages/services/ac-cleaning.html">AC Cleaning Dubai</a></li>
...
function renderFloats() {
  ...
  el.innerHTML = `
    <a href="${SITE.whatsapp}" target="_blank" rel="noopener" class="whats fl-btn wa" aria-label="WhatsApp">
    ...
    <a href="${SITE.phoneTel}" class="telef fl-btn ph" aria-label="Call us">
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M22 16.92v3a2 2 0 01-2.18 2 19.79 19.79 0 01-8.63-3.07A19.5 19.5 0 013.07 8.8 19.79 19.79 0 01.22 2.18 2 2 0 012.18 0h3a2 2 0 012 1.72c.127.96.361 1.903.7 2.81a2 2 0 01-.45 2.11L6.91 7.91a16 16 0 006.16 6.16l1.27-1.27a2 2 0 012.11-.45c.907.339 1.85.573 2.81.7A2 2 0 0122 16.92z"/></svg>
      <span class="fl-label">Call Us</span>
    </a>
    <a href="${SITE.emailLink}" class="emailing fl-btn em" aria-label="Email">
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"/><polyline points="22,6 12,13 2,6"/></svg>
    ...
    <div class="popup-box" role="dialog" aria-modal="true" aria-labelledby="popup-title">
      ...
      <div class="popup-body">
        <form id="popup-form" novalidate>
          <input type="hidden" name="access_key" value="${SITE.web3key}">
          <input type="hidden" name="subject" value="Consultation Request — ${SITE.name}">
          ...
          <div class="form-row">
            ...
            <div class="form-grp">
              ...
              <input type="tel" id="p-phone" name="phone" placeholder="${SITE.phone}" required>
            </div>
          </div>
          <div class="form-grp">
            <label for="p-email">Email Address</label>
            <input type="email" id="p-email" name="email" placeholder="${SITE.email}">
          </div>
          <div class="form-row">
            <div class="form-grp">
